...
namespace Team2_Project
{
    public partial class frmDefectCode : frmCodeControlBase
    {
        ...
        private void frmDefectCode_Load(object sender, EventArgs e)
        {
            ...
            DataGridViewUtil.AddGridTextBoxColumn(dataGridView1, "불량현상 대분류코드", "", 200);
            DataGridViewUtil.AddGridTextBoxColumn(dataGridView1, "불량현상 대분류명", "", 200);

            DataGridViewUtil.SetInitDataGridView(dataGridView2);
            DataGridViewUtil.AddGridTextBoxColumn(dataGridView2, "불량현상 상세분류코드", "", 200);
            DataGridViewUtil.AddGridTextBoxColumn(dataGridView2, "불량현상 상세분류명", "", 200);
