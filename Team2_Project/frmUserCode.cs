...
namespace Team2_Project
{
    public partial class frmUserCode : frmCodeControlBase
    {
        ...
        private void frmUserCode_Load(object sender, EventArgs e)
        {
            ...
            DataGridViewUtil.AddGridTextBoxColumn(dataGridView1, "사용자정의 대분류코드", "", 200);
            DataGridViewUtil.AddGridTextBoxColumn(dataGridView1, "사용자정의 대분류명", "", 200);

            DataGridViewUtil.SetInitDataGridView(dataGridView2);
            DataGridViewUtil.AddGridTextBoxColumn(dataGridView2, "사용자정의 상세분류코드", "", 200);
            DataGridViewUtil.AddGridTextBoxColumn(dataGridView2, "사용자정의 상세분류명", "", 200);
